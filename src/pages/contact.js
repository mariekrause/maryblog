  ...
  return (
    <Layout>
      ...
      <div className="two-grids">
        ...
        <div className="post-featuredimage" style={{backgroundImage: `url('/assets/palette.jpeg')`, marginBottom: 0}}>
        ...
        <div className="post-featuredimage" style={{backgroundImage: `url('/assets/tweet.jpeg')`, marginBottom: 0}}>
        ...
        <div className="post-featuredimage" style={{backgroundImage: `url('/assets/film.jpeg')`, marginBottom: 0}}>
